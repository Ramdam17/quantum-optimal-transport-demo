"""Execute every 00–03 course notebook end-to-end, offline, to guard against silent breakage.
...
Scope grows by plan: modules 00–01 (Plan C), 02 (Plan D), 03 (Plan E), 04 (Plan F); later plans widen ``NOTEBOOK_GLOB``.
